...
/*
    ...
    This is Amortized O(1) for each operation.

    Function "transfer()" only happens when stack_out is EMPTY, which is what
    guarantees amortization.
