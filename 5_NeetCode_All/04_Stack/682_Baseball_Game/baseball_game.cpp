...
public:
    int calPoints(vector<string>& operations)
    {
        ...
        // We are certain the very first element is an integer
        stack.push(std::stoi(operations[0]));
        sum += std::stoi(operations[0]);
