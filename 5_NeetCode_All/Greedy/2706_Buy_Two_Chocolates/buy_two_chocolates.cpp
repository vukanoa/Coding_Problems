...
/*
    ...
    =======================================================
    FUNCTION: int buyChoco(vector<int>& prices, int money);
    =======================================================
    ...
    Explanation: Purchase the chocolates priced at 1 and 2 units respectively.
                 You will have 3 - 3 = 0 units of money afterwards. Thus, we
                 return 0.
...
public:
    int buyChoco(vector<int>& prices, int money)
    {
        ...
        for (int i = 0; i < prices.size(); i++)
        {
            ...
            else if (prices[i] < second_cheapest)
            {
                second_cheapest = prices[i];
            }
        }

        if (cheapest + second_cheapest > money)
            return money;
