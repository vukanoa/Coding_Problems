/*
    ...
    absolute difference between the index of the occurrence of each character
    in s and the index of the occurrence of the same character in t.

    Return the permutation difference between s and t.

    ============================================================
    FUNCTION: int findPermutationDifference(string s, string t);
    ============================================================
