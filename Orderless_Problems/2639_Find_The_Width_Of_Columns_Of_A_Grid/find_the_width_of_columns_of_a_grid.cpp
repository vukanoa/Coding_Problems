/*
    ...
    =================================================================
    FUNCTION: vector<int> findColumnWidth(vector<vector<int>>& grid);
    =================================================================
...
/* Space Complexity: O(COLS)        */ // Result is usually not EXTRA, but w/e
class Solution {
public:
    vector<int> findColumnWidth(vector<vector<int>>& grid)
    {
        ...
        for (int col = 0; col < COLS; col++)
        {
            ...
            {
                int curr_len = to_string(grid[row][col]).length();
