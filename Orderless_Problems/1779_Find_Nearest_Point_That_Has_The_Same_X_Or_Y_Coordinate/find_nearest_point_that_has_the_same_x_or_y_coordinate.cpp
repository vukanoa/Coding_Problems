/*
    ...
    valid point with the smallest index. If there are no valid points, return
    -1.
    ...
    ===========================================================================
    FUNCTION: int nearestValidPoint(int x, int y, vector<vector<int>>& points);
    ===========================================================================
...
public:
    int nearestValidPoint(int x, int y, vector<vector<int>>& points)
    {
        ...
        for (int i = 0; i < SIZE; i++)
        {
            ...
            if (a == x || b == y)
            {
                int curr_distance = manhattan_distance(x, a, y, b);
...
private:
    int manhattan_distance(int x, int a, int y, int b)
    {
