/*
    ...
    procedure:
        ...
        + The first group consists of the first k characters of the string, the
          ...
          on. Each element can be a part of exactly one group.
    ...
    ==================================================================
    FUNCTION: vector<string> divideString(string s, int k, char fill);
    ==================================================================
...
public:
    vector<string> divideString(string s, int k, char fill)
    {
        ...
        for (int i = 0; i < N; i+=k)
        {
            ...
            if (group.length() < k)
            {
                int diff = k - group.length();
                string addition(diff, fill);
