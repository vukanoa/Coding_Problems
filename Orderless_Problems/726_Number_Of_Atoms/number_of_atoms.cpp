...
/*
    ...
    ==============================================
    FUNCTION: string countOfAtoms(string formula); 
    ==============================================
...
public:
    string countOfAtoms(string formula)
    {
        ...
        stack<map<string, int>> stack; // We need MAP, no UMAP!
        ...
        for (int i = 0; i < n;)
        {
            ...
            else if (formula[i] == ')')
            {
                ...
                for (auto &entry : top)
                    stack.top()[entry.first] += entry.second * multiplier;
            }
            else
            {
                int i_start = i;
