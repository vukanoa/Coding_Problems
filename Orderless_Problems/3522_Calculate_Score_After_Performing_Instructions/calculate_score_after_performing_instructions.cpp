/*
    ...
    You need to simulate a process based on the following rules:
        ...
        + You start at the first instruction at index i = 0 with an initial
          score of 0.
        ...
        + If instructions[i] is "jump":
            + Move to the instruction at index (i + values[i]) without
    ...
    ======================================================================================
    FUNCTION: long long calculateScore(vector<string>& instructions, vector<int>& values);
    ======================================================================================
