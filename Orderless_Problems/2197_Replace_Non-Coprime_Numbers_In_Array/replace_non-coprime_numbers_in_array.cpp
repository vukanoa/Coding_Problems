/*
    ...
    ============================================================
    FUNCTION: vector<int> replaceNonCoprimes(vector<int>& nums);
    ============================================================
...
/*
    ...
    Once you know about LCM and GCD, which is trivial, this is one of the
    easier HARDs on the LeetCode.
...
/* Time  Complexity: O(N * logM) */ // Where 'M' is the maximum value in nums
...
public:
    vector<int> replaceNonCoprimes(vector<int>& nums)
    {
        ...
        for (int num : nums)
        {
            while (!stack.empty())
            {
                int curr_top = stack.back();
                int curr_gcd = gcd(curr_top, num);
