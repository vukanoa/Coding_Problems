/*
    ...
    The game proceeds as follows:
        ...
        + In each turn, a player must choose either one of the lane and pick
          one flower from that side.

        + At the end of the turn, if there are no flowers left at all, the
          current player captures their opponent and wins the game.
    ...
    =============================================
    FUNCTION: long long flowerGame(int n, int m);
    =============================================
