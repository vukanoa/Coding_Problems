...
/*
    ...
    ===========================================================
    FUNCTION: int minDays(vector<int>& bloomDay, int m, int k);
    ===========================================================
    ...
    flower bloomed and _ means flower did not bloom in the garden.  We need 3
    bouquets each should contain 1 flower.
...
/*
    ...
    Where M = max(bloomDay) - min(bloomDay)
*/
/*
...
private:
    bool canMakeBouquets(std::vector<int>& bloomDay, int m, int k, int day)
    {
        int total = 0;
