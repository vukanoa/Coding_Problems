...
/*
    ...
    ==================================================================
    FUNCTION: int findContentChildren(vector<int>& g, vector<int>& s);
    ==================================================================
    ...
    Explanation: You have 3 children and 2 cookies. The greed factors of 3
                 children are 1, 2, 3.  And even though you have 2 cookies,
    ...
    Explanation: You have 2 children and 3 cookies. The greed factors of 2
                 children are 1, 2.  You have 3 cookies and their sizes are big
...
/* Space Complexity: O(n) or O(1), depending on the sort */
class Solution {
public:
