/*
    ...
    ====================================================================
    FUNCTION: int maximalNetworkRank(int n, vector<vector<int>>& roads);
    ====================================================================
    ...
    Explanation: The network rank of cities 0 and 1 is 4 as there are 4 roads
                 that are connected to either 0 or 1. The road between 0 and 1
    ...
    Output: 5
    Explanation: The network rank of 2 and 5 is 5. Notice that all the cities
...
public:
    int maximalNetworkRank(int n, vector<vector<int>>& roads)
    {
        ...
        for (const vector<int>& road : roads)
        {
            ...
            connected[one][two] = true;
            connected[two][one] = true;
