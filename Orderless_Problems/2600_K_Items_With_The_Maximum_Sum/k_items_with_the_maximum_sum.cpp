/*
    ...
    =====================================================================================
    FUNCTION: int kItemsWithMaximumSum(int numOnes, int numZeros, int numNegOnes, int k);
    =====================================================================================
    ...
    {1, 1, 1, 0, 0}. We take 2 items with 1 written on them and get a sum in a
    total of 2.
    ...
    Output: 3
    Explanation: We have a bag of items with numbers written on them
    {1, 1, 1, 0, 0}. We take 3 items with 1 written on them, and 1 item with 0
    written on it, and get a sum in a total of 3.
