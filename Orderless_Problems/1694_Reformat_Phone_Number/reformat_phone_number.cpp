/*
    ...
    remove all spaces and dashes. Then, group the digits from left to right
    into blocks of length 3 until there are 4 or fewer digits. The final digits
    ...
    ===============================================
    FUNCTION: string reformatNumber(string number);
    ===============================================
...
public:
    string reformatNumber(string number)
    {
        ...
        const int NUM_OF_DIGITS = digits.length();

        int i = 0;
        while (i < NUM_OF_DIGITS)
        {
            if (NUM_OF_DIGITS - i == 4)
            {
