/*
    ...
    You must perform an operation shift(c, x), where c is a character and x is
    a digit, that returns the xth character after c.

        For example, shift('a', 5) = 'f' and shift('x', 0) = 'x'.

    For every odd index i, you want to replace the digit s[i] with the result
    of the shift(s[i-1], s[i]) operation.
    ...
    =========================================
    FUNCTION: string replaceDigits(string s);
    =========================================
