/*
    ...
    =============================================
    FUNCTION: bool isPossible(vector<int>& nums);
    =============================================
...
public:
    ...
    {
        unordered_map<int, int> remaining_freq;
        unordered_map<int, int> subseq_end_freq;
        ...
        for (const int& num: nums)
        {
            ...
            if (subseq_end_freq[num - 1] > 0)
            {
                subseq_end_freq[num - 1]--;
                subseq_end_freq[num]++;
            }
            else if (remaining_freq[num + 1] > 0 && remaining_freq[num + 2] > 0)
            {
                remaining_freq[num + 1]--;
                remaining_freq[num + 2]--;
                subseq_end_freq[num + 2]++;
            }
            else
            {
                return false;
