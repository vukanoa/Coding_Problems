/*
    ...
    You are given 2 integer arrays nums1 and nums2 of lengths n and
    ...
    =================================================================================
    FUNCTION: long long numberOfPairs(vector<int>& nums1, vector<int>& nums2, int k);
    =================================================================================
    ...
    Output: 5
    Explanation: The 5 good pairs are (0, 0), (1, 0), (1, 1), (2, 0), and
                 (2, 2).
