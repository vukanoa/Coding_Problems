...
/*
    ...
    Since we're indeed allowed to take a subarray more than once, then we
    should precisely do that. Pick the subarray that containts maximum and
    minimum value and then use it exactly k times.
