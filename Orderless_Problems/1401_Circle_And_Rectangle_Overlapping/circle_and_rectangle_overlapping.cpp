/*
    ...
    ==================================================================================================
    FUNCTION: bool checkOverlap(int radius, int xCenter, int yCenter, int x1, int y1, int x2, int y2);
    ==================================================================================================
...
public:
    bool checkOverlap(int radius, int xCenter, int yCenter, int x1, int y1, int x2, int y2)
    {
        ...
        int distance = (nearest_x - xCenter)*(nearest_x - xCenter) + (nearest_y - yCenter)*(nearest_y - yCenter);
