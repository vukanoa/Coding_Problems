/*
    ...
    ===============================================================================
    FUNCTION: vector<int> createTargetArray(vector<int>& nums, vector<int>& index);
    ===============================================================================
...
/* Space Complexity: O(1)   */ // "result" is NOT extra
class Solution {
public:
    vector<int> createTargetArray(vector<int>& nums, vector<int>& index) 
    {
        ...
        for (int i = 0; i < N; i++) // O(N)
            result.insert(result.begin() + index[i], nums[i]); // O(N)
