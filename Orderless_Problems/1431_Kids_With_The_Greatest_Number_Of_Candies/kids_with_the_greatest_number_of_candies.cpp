/*
    ...
    ===============================================================================
    FUNCTION: vector<bool> kidsWithCandies(vector<int>& candies, int extraCandies);
    ===============================================================================
...
public:
    vector<bool> kidsWithCandies(vector<int>& candies, int extraCandies)
    {
        ...
        int maximum_amount_of_candies = *max_element(candies.begin(), candies.end());

        for (const int& candy : candies)
            result.push_back(candy + extraCandies >= maximum_amount_of_candies);
