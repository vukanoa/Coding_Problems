/*
    ...
    three elements from the array, compute their median, and remove the
    ...
    ========================================================
    FUNCTION: long long maximumMedianSum(vector<int>& nums);
    ========================================================
    ...
    Explanation:
        + In the first step, select elements at indices 2, 4, and 5, which have
          a median 3. After removing these elements, nums becomes [2, 1, 2].

        + In the second step, select elements at indices 0, 1, and 2, which
          have a median 2. After removing these elements, nums becomes empty.
    ...
    Explanation:
        + In the first step, select elements at indices 0, 2, and 3, which have
          a median 10. After removing these elements, nums becomes [1, 10, 10].

        + In the second step, select elements at indices 0, 1, and 2, which
          have a median 10. After removing these elements, nums becomes empty.
