/*
    ...
    ==================================================
    FUNCTION: int minimumDeletions(vector<int>& nums);
    ==================================================
...
/*
    ...
    There are only three ways to delete. Self-explanatory.
...
public:
    int minimumDeletions(vector<int>& nums)
    {
        ...
        int minima_idx = min_element(nums.begin(), nums.end()) - nums.begin();
        int maxima_idx = max_element(nums.begin(), nums.end()) - nums.begin();

        int L = min(minima_idx, maxima_idx);
        int R = max(minima_idx, maxima_idx);
