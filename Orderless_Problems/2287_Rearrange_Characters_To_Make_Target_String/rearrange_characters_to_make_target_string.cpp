...
/*
    ...
    ===========================================================
    FUNCTION: int rearrangeCharacters(string s, string target);
    ===========================================================
...
/*
    ...
    This question is the same as 1189: Maximum Number of Balloons.
    Check that one out.
...
public:
    ...
    {
        vector<int> counter_target(26, 0);
        for (const char& chr : target)
            counter_target[chr - 'a']++;
        ...
        int result = INT_MAX;
        for (const char& chr : target)
            result = min(result, counter_s[chr - 'a'] / counter_target[chr - 'a']);
