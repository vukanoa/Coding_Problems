/*
    ...
    To perform a flood fill:
        ...
        + Perform the same process for each pixel that is directly adjacent
          ...
          horizontally or vertically) and shares the same color as the starting
          pixel.
    ...
    ===============================================================================================
    FUNCTION: vector<vector<int>> floodFill(vector<vector<int>>& image, int sr, int sc, int color);
    ===============================================================================================
...
private:
    void dfs(vector<vector<int>>& image, int row, int col, int color, int original_value)
    {
        ...
        dfs(image, row-1, col  , color, original_value); // Up
        dfs(image, row+1, col  , color, original_value); // Down
        dfs(image, row  , col-1, color, original_value); // Left
        dfs(image, row  , col+1, color, original_value); // Right
