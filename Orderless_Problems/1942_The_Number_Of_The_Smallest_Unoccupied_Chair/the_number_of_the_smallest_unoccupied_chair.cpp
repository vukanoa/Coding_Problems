...
/*
    ...
    When a friend leaves the party, their chair becomes unoccupied at the
    moment they leave. If another friend arrives at that same moment, they can
    sit in that chair.
    ...
    ==========================================================================
    FUNCTION: int smallestChair(vector<vector<int>>& times, int targetFriend);
    ==========================================================================
...
public:
    int smallestChair(vector<vector<int>>& times, int targetFriend)
    {
        ...
        priority_queue<pair<int, int>, vector<pair<int, int>>, greater<pair<int, int>>> taken_seats;
        ...
        for (int i : order)
        {
            ...
            while ( ! taken_seats.empty() && taken_seats.top().first <= arrival)
            {
