/*
    ...
    In other words:
        ...
        + max(nums[0..i]) is the largest value among the elements from index 0
                          to index i.
    ...
    =========================================================
    FUNCTION: int firstStableIndex(vector<int>& nums, int k);
    =========================================================
...
public:
    int firstStableIndex(vector<int>& nums, int k)
    {
        ...
        for (int i = 0; i < N; i++)
        {
            int score = prefix_max[i] - suffix_min[i];
