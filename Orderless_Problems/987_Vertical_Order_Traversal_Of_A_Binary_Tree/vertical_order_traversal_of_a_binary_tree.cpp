/*
    ...
    ending on the rightmost column. There may be multiple nodes in the same row
    and same column. In such a case, sort these nodes by their values.

    Return the vertical order traversal of the binary tree.

    ================================================================
    FUNCTION: vector<vector<int>> verticalTraversal(TreeNode* root);
    ================================================================
...
public:
    vector<vector<int>> verticalTraversal(TreeNode* root)
    {
        ...
        for (const auto& node : nodes) {
            ...
            for (const auto& row_entry : node.second)
                col.insert(col.end(), row_entry.second.begin(), row_entry.second.end());
