/*
    ...
    following rules:
        ...
        + For an n-bytes character, the first n bits are all one's, the n + 1
    ...
    ============================================
    FUNCTION: bool validUtf8(vector<int>& data);
    ============================================
...
/*
    ...
    The difficult part here is not to make a mistake by figuring out the
    borders for each n-byte.
