/*
    ...
    =================================================================
    FUNCTION: vector<int> exclusiveTime(int n, vector<string>& logs);
    =================================================================
...
/* Time  Complexity: O(L) */ // L <==> Number of Logs
...
public:
    vector<int> exclusiveTime(int n, vector<string>& logs)
    {
        ...
        {
            int id        = stoi(str.substr(0, str.find(':')));
            int timestamp = stoi(str.substr(str.rfind(':') + 1));

            if (str.find('e') != -1)
            {
                result[id] += timestamp - prev_time + 1;
                stack.pop();
            ...
            {
                if ( ! stack.empty())
                    result[stack.top().first] += timestamp - prev_time;
