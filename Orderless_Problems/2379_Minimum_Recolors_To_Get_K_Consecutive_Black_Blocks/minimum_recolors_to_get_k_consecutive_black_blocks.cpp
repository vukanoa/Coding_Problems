/*
    ...
    either 'W' or 'B', representing the color of the ith block.
    ...
    ====================================================
    FUNCTION: int minimumRecolors(string blocks, int k);
    ====================================================
...
/*
    ...
    The most simple use of Fixed-Sliding Window technique.
