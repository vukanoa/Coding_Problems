/*
    ...
    count toward the space complexity mentioned above, as some languages do not
    support in-place resizing.

    =================================================================
    FUNCTION: vector<int> limitOccurrences(vector<int>& nums, int k);
    =================================================================
...
public:
    vector<int> limitOccurrences(vector<int>& nums, int k)
    {
        ...
        return {nums.begin(), nums.begin() + L};
    }
};
