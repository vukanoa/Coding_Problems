...
/*
    ...
    In one operation, you can:
        ...
        Choose a star in s.  Remove the closest non-star character to its left,
        as well as remove the star itself.

    Return the string after all stars have been removed.

    =====
    Note: The input will be generated such that the operation is always
          possible.  It can be shown that the resulting string will always be
          unique.

    =====

    =======================================
    FUNCTION: string removeStars(string s);
    =======================================
    ...
    --- Example 1 ---
    Input: s = "leet**cod*e" Output: "lecoe" Explanation: Performing the
    removals from left to right:
