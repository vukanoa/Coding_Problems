...
/*
    ...
    =======================================================
    FUNCTION: int maxScore(vector<int>& cardPoints, int k);
    =======================================================
...
public:
    int maxScore(vector<int>& cardPoints, int k)
    {
        ...
        int sum_last_k_points  = std::accumulate(cardPoints.end() - k, cardPoints.end(), 0);
        int result = sum_last_k_points;

        if (n == k)
            return sum_last_k_points; // Or sum_last_k_points, it's the same
