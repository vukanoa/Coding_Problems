...
/*
    ...
    Implement the ParkingSystem class:
        ...
        Initializes object of the ParkingSystem class. The number of slots for
        ...
        wants to get into the parking lot. carType can be of three kinds: big,
        medium, or small, which are represented by 1, 2, and 3 respectively. A
        car can only park in a parking space of its carType. If there is no
...
public:
    ParkingSystem(int big, int medium, int small)
        : parking_slots(4)
    {
        parking_slots[0] = -1; // Because indexing starts from 0
        parking_slots[1] = big;
        parking_slots[2] = medium;
        parking_slots[3] = small;
    }

    bool addCar(int carType)
    {

        if (parking_slots[carType] == 0)
            return false;

        parking_slots[carType]--;
        return true;
    }
