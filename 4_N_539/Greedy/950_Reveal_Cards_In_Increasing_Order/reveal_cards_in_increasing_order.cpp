...
/*
    ...
    =====
    Note: Note that the first entry in the answer is considered to be the top
          of the deck.
    =====

    ================================================================
    FUNCTION: vector<int> deckRevealedIncreasing(vector<int>& deck);
    ================================================================
...
public:
    vector<int> deckRevealedIncreasing(vector<int>& deck)
    {
        ...
        for (const int& unique_card : deck)
        {
            int i = deque.front();
            deque.pop_front();

            result[i] = unique_card;

            if ( ! deque.empty())
            {
                i = deque.front();
                deque.pop_front();  // Skip it

                deque.push_back(i); // Place it at the bottom
            }
        }
