...
/*
    ...
    Anoher way of imlementing and thinking about this Basic Solution. Some
    people will find this one easier to grasp.

    Essentially, what we want is, out of k largest elements in vector "nums",
    give me the smallest out of those k.

    Therefore we make a heap of all the elements from "nums" and pop the
    absolute lowest one-by-one, until we end up with k largest. Then once we
    have k largest, we just take the smallest one, which is at the top of the
    min_heap.
